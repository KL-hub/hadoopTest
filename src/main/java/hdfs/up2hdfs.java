...
public class up2hdfs {
    ...
    private static String HDFSUri = "hdfs://www.lixiang.ac.cn:9000";
    ...
    public static void copyFileToHDFS(String srcFile, String destPath) throws Exception {
        ...
        config.set("fs.defaultFS", "hdfs://lixiang:8020");
    ...
    public static void main(String[] args) throws Exception {
        ...
        //上传文件到HDFS
        copyFileToHDFS("C:\\Users\\李项\\Desktop\\新建文本文档.txt", "/dit/HDFSTest.txt");
        //下载文件到本地
        getFile("/dit/HDFSTest.txt", "f:\\HDFSTest.txt");
